...
of the EE5239_project folder. That folder contains the custom code we used for our project. It also has further instructions on how to run our code. This repository was forked from the SAM2 repository. What follows is the README for the original SAM2 repository.
